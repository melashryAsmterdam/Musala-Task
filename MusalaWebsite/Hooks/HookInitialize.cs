...
public class HookInitialize : TestInitializeHook
{
    ...
    public void Initialize()
        ...
        //    //Get feature Name
        //    featureName = extent.CreateTest.ExtentReports<AventStack.ExtentReports.Gherkin.Model.Feature>(_featureContext.FeatureInfo.Title);

        //    //Create dynamic scenario name
        //    _currentScenarioName = featureName.CreateNode<AventStack.ExtentReports.Gherkin.Model.Scenario>(_scenarioContext.ScenarioInfo.Title);
        //}

        {
          ...
          //  Console.Write("data="+_featureContext.FeatureInfo.Title);
            //Get feature Name
